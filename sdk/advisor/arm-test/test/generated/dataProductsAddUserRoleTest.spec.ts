...
describe("assign role to the data product", () => {
  ...
  it("should assign role to the data product for dataProductsAddUserRoleMaximumSetGen", async function () {
    ...
    assert.strictEqual(result.principalId, "00000000-0000-0000-0000-00000000000");
    ...
    assert.strictEqual(result.roleAssignmentId, "00000000-0000-0000-0000-00000000000");
  });
});
