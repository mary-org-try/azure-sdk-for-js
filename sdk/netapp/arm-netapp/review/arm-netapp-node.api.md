...
export interface AccountProperties {
    ...
    // Warning: (ae-forgotten-export) The symbol "NetAppAccount_1" needs to be exported by the entry point index.d.ts
    //
    // (undocumented)
    prop1?: NetAppAccount_1;
    // Warning: (ae-forgotten-export) The symbol "NetAppAccountAutoGenerated" needs to be exported by the entry point index.d.ts
    //
    // (undocumented)
